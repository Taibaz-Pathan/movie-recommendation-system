...
add_paragraph(doc, "The main deliverables from this week were:", space_after=4)
add_bullet(
    doc,
    "A structured folder layout following Python packaging conventions, "
    "with separate directories for data, source code, notebooks, tests, and reports.",
)
add_bullet(
    doc,
    "A centralised configuration file (configs/config.yaml) for dataset "
    "paths, split parameters, and logging settings.",
)
add_bullet(
    doc,
    "A data loading module (src/data/loader.py) that reads the MovieLens "
    "CSV files and automatically converts the Unix timestamp column to a "
    "human-readable datetime.",
)
add_bullet(
    doc,
    "An evaluation metrics module (src/evaluation/metrics.py) containing "
    "RMSE and MAE functions with full input validation.",
)
add_bullet(
    doc,
    "Skeleton classes for the two CF models that will be fully implemented "
    "in Weeks 5 and 6.",
)
add_bullet(
    doc,
    "A test suite with 17 passing unit tests covering the loader and "
    "metrics modules.",
)
add_paragraph(
    doc,
    "The Git repository was initialised on branch main with the "
    "first commit at the end of the week.",
    space_before=4,
    space_after=10,
)
...
add_inline(
    ...
    [
        ...
        (
            ...
            "This bias will need to be corrected through mean-centring in the CF models.",
            False,
        ),
    ],
    space_after=6,
...
add_inline(
    ...
    [
        ...
        (
            ...
            "because there are too few co-rated movies to compute a meaningful similarity.",
            False,
        ),
    ],
    space_after=6,
...
add_inline(
    ...
    [
        ...
        (
            ...
            "significant drift in user behaviour over time.",
            False,
        ),
    ],
    space_after=10,
...
add_inline(
    ...
    [
        ...
        (
            ...
            "because rare movies have been removed.",
            False,
        ),
    ],
    space_after=6,
...
add_inline(
    ...
    [
        ...
        (
            ...
            "ratings, with the random seed fixed at 42 for reproducibility.",
            False,
        ),
    ],
    space_after=6,
...
add_paragraph(
    doc, "18 unit tests were written for this module, all passing.", space_after=10
)
...
add_inline(
    doc,
    [
        ("pearson_similarity(u, v, min_support).  ", True),
        (
            ...
            "min_support, the function returns 0.0 rather than an unreliable score.",
            False,
        ),
    ],
    space_after=6,
...
add_inline(
    doc,
    [
        ("cosine_similarity_matrix(matrix).  ", True),
        (
            ...
            "similarity is computed as a single matrix multiplication.",
            False,
        ),
    ],
    space_after=6,
...
add_inline(
    doc,
    [
        ("pearson_similarity_matrix(matrix, min_support).  ", True),
        (
            ...
            "566 x 1,286 matrix without nested Python loops.",
            False,
        ),
    ],
    space_after=6,
...
add_paragraph(
    doc, "22 unit tests were written for this module, all passing.", space_after=10
)
...
add_inline(
    ...
    [
        ...
        (
            ...
            "evaluated on the test split using RMSE and MAE.",
            False,
        ),
    ],
    space_after=6,
